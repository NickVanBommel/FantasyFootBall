<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/User.Master" CodeBehind="UserPlayers.aspx.vb" Inherits="SE3309.UserPlayers" %>
    ...
    <div style="margin-left:50px; margin-top:50px;">
        ...
        <asp:GridView runat="server" ID="gvPlayers" AutoGenerateColumns="false">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="lbtnAddPlayer" CommandArgument='<%#Eval("PlayerID")%>' CommandName="AddPlayer" Text="Add Player" OnClick="lbtnAddPlayer_Click"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
